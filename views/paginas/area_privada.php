                    ...
                    <div class="privada__imagen">
                        ...
                        ">
                            <div class="privada__boleto--container">
                                <!-- <h4 class="privada__boleto-logo">ADCS</h4> -->
                    ...
                    <div class="privada__contenido">
                        ...
                        <div class="privada__caja-datos">
                            ...
                            <div class="privada__datos privada__datos--tallas">
                                ...
                                <p><?php echo 'Camiseta: ' . ($miembro->talla_camiseta ? strtoupper($miembro->talla_camiseta) : '-'); ?></p>
                                <p><?php echo 'Calzona: ' . ($miembro->talla_calzona ? strtoupper($miembro->talla_calzona) : '-'); ?></p>
                                <p><?php echo 'Chandal: ' . ($miembro->talla_chandal ? strtoupper($miembro->talla_chandal) : '-'); ?></p>
                                <p><?php echo 'Cortavientos: ' . ($miembro->talla_cortavientos ? strtoupper($miembro->talla_cortavientos) : '-'); ?></p>
                            </div>
                            <div class="privada__datos privada__datos--tallas">
                                <h4 class="
                                    <?php echo (trim($miembro->nombre_pack) === "Solo Entrenos") ? 'entrenos' : ''; ?>
