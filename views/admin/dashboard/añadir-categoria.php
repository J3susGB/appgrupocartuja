...
<div class="dashboard__formulario">
    ...
    <form method="POST" action="/admin/dashboard/añadir-categoria" class="formulario" novalidate>
        ...
        <input type="submit" class="alerta formulario__submit formulario__submit--registrar" value="Añadir categoría">
    </form>
</div>