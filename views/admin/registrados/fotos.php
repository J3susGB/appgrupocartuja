...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton--panel" href="/admin/registrados/fotos-añadir">
                        ...
                        <div class="galeria__container">
                            ...
                            <?php if(is_admin() || es_organizador()) {?>
                                <div class="galeria__acciones">
                                    <a class="acciones-foto editar-galeria table__accion table__accion--editar" href="/admin/registrados/editar-foto?id=<?php echo $foto->id; ?>">
