                ...
                <?php foreach ($registros as $registro) { ?>
                    <div class="bloque__contenido">
                        <p class="bloque__texto">
                            <?php echo "- " . $registro->nombre . " " . $registro->apellido1 . " " . $registro->apellido2; ?>
                        </p>
                    </div>
                <?php } ?>
            </div>
            <div class="bloque">
                <h3 class="bloque__heading">Miembros</h3>
                <div class="bloque__contenido">
                    <p class="bloque__texto--cantidad">
                        <?php echo $usuarios . " personas"; ?>
                    </p>
                </div>
            </div>
            <div class="bloque">
                <h3 class="bloque__heading">Resumen Cuentas</h3>
                <div class="bloque__contenido--dinero">
                    <p class="bloque__texto--cuentas">
                        <?php echo "- Total ingresos: " . round($ingresos, 2) . " €"; ?>
                    </p>
                    <p class="bloque__texto--cuentas">
                        <?php echo "- Total gastos: " . round($gastos, 2) . " €"; ?>
                    </p>
                </div>
            </div>
            <div class="bloque">
